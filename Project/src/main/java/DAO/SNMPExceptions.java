    ...
    public static final int FILE_NOT_FOUND = 1;
       ...
       */
       ...
       public SNMPExceptions(String pvcMensajeParaUsuario){
          ...
          /**
           * Constructor que Ã¡demas recibe el cÃ³digo del error de la exception para inmprimirlo en la consola para el desarrollador
          ...
          /**
           * Constructor que Ã¡demas recibe la base de datos en la que se origino la exception para imprimir un mesaje personalizado
           * de acuerdo al cÃ³digo de error, aplica para SQLException
           * @param pvnTipoException
           * @param pvcMensaje
           * @param pvnCodigoError
           * @param pvnBD
