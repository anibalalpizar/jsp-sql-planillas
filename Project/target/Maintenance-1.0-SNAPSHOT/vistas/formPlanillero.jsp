        ...
        <body class="hold-transition skin-blue sidebar-mini">
            <div class="wrapper">
                            ...
                            <ul class="nav navbar-nav">
                                ...
                                <li class="dropdown user user-menu">
                                    ...
                                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                        ...
                                        <span class="hidden-xs"> ${vendedor.nombreususario} </span>
                                    </a>
                                    <ul class="dropdown-menu">
                                        ...
                                        <li class="user-header">
                                            ...
                                            <p>
                                                Bienvenido - ${vendedor.nombreususario}
                    ...
                    <section class="sidebar">
                        ...
                        <div class="user-panel">
                            ...
                            <div class="pull-left info">
                                <p>Bienvenido, ${vendedor.nombreususario} </p>
                                <!-- Status -->
                        ...
                        <ul class="sidebar-menu" data-widget="tree">
                            ...
                            <li class="active">
                                <a href="#"
                                   ><i class="fa fa-link"></i> <span>Panel Administrativo</span></a
                                >
                            </li>
                            <li class="treeview">
                                <a href="#"
                                   ><i class="fa fa-cart-arrow-down"></i> <span>Mantenimientos</span>
                ...
                <footer class="main-footer">
                    ...
                    <!-- Default to the left -->
                    <strong>Copyright &copy; 2020 <a href="#">IDAT</a>.</strong> Todos los
                    derechos reservados.
                </footer>
